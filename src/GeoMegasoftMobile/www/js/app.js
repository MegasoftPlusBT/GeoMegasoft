        ...
        vm.saveNewState = function () {
          if(vm.state.new == null || vm.state.new < vm.state.before){
            $ionicPopup.alert({
              ...
              template: 'Новата состојба е невалидна.'
            });
            return;
          }
